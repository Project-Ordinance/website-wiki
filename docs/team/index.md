...
> Last updated: 2025-11-22. If your role, avatar, name or description may be outdated, please open an issue/PR or contact an Riggs on Discord.
...
<div class="po-role">
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/CaptainJohnnySins.png" alt="Captain Johnny Sins avatar" />
        <div>
    ...
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/Default.svg" alt="KingKuj avatar" />
        <div>
    ...
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/Default.svg" alt="Lee West avatar" />
        <div>
    ...
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/Default.svg" alt="LordMax avatar" />
        <div>
...
<div class="po-role">
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/Default.svg" alt="Atlas avatar" />
        <div>
    ...
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/Default.svg" alt="Harry Pootis avatar" />
        <div>
    ...
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/Default.svg" alt="The G-Ninja avatar" />
        <div>
...
<div class="po-role">
    <div class="po-member">
        <img class="po-avatar" src="../assets/avatars/Default.svg" alt="CreekMando avatar" />
        <div>
